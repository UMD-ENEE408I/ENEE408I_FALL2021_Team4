...
async def sendData(client, instruction):
...
async def recvData(client):
    ...
    # finished = intBuf & 0b1000
    # left = intBuf & 0b0100
    # straight = intBuf & 0b0010
    # right = intBuf & 0b0001
	...
	return [DIRECTION_DATA, DISTANCE_DATA, RESERVED_DATA]
...
def send_instr(instruction):
    sendData(client, instruction)
    data = recvData(client)
    return data
